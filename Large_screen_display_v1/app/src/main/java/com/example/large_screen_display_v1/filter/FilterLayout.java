...
import com.example.large_screen_display_v1.filter.flow.FlowLayout;
import com.example.large_screen_display_v1.filter.flow.TagFlowAdapter;
import com.example.large_screen_display_v1.filter.flow.TagFlowContainer;
    ...
    public void setFilterData(List<FilterGrop> filterData) {
        ...
        for (int i = 0; i < filterData.size(); i++) {
            ...
            if (filterGrop != null) {
                ...
                filterMore.setOnClickListener(new OnClickListener() {
                    @Override
